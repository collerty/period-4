...
const buttonStyle = tva({
  ...
  variants: {
    ...
    variant: {
      link: 'px-0',
      outline:
          'bg-transparent border border-typography-900 data-[hover=true]:bg-background-50 data-[active=true]:bg-transparent',      solid: '',
    },
...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    ...
    variant: {
      ...
      outline: '',
      solid:
          'text-black data-[hover=true]:text-typography-900 data-[active=true]:text-typography-900',    },
    size: {
      xs: 'text-xs',
      sm: 'text-sm',
      md: 'text-base',
